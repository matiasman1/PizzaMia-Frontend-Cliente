...
export const actualizarDomicilio = async (
    ...
    // Estrategia 1: PUT directo simple
    try {
        console.log("🔄 Estrategia 1: PUT directo simple");
    ...
    // Estrategia 2: PUT con estructura de localidad como objeto
    try {
        console.log("🔄 Estrategia 2: PUT con localidad como objeto");
        
        const datosConLocalidadObjeto = {
            calle: domicilioData.calle,
            numero: domicilioData.numero,
            pisoDpto: domicilioData.pisoDpto || "",
            codigoPostal: domicilioData.codigoPostal,
    ...
    // Estrategia 3: PATCH en lugar de PUT
    try {
        console.log("🔄 Estrategia 3: PATCH simple");
    ...
    // Estrategia 4: POST a endpoint update
    try {
        console.log("🔄 Estrategia 4: POST a /domicilios/update");
    ...
    // Estrategia 5: PUT con estructura completa (incluyendo ID)
    try {
        console.log("🔄 Estrategia 5: PUT con estructura completa");
    ...
    // Estrategia 6: PATCH con estructura completa
    try {
        console.log("🔄 Estrategia 6: PATCH con estructura completa");
        ...
        console.log("✅ Estrategia 6 exitosa:", response.data);
        return response.data;
    } catch (error) {
        console.log("❌ Estrategia 6 falló:", error);
        if (axios.isAxiosError(error)) {
            console.log("Status:", error.response?.status);
            console.log("Data:", error.response?.data);
        }
    ...
    // Estrategia 7: PUT a endpoint alternativo
    try {
        console.log("🔄 Estrategia 7: PUT a /domicilios/actualizar");
        
        const response = await axios.put(
            `${API_BASE_URL}/domicilios/actualizar/${domicilioId}`,
            domicilioData,
            {
                headers: {
                    'Content-Type': 'application/json',
        ...
        console.log("✅ Estrategia 7 exitosa:", response.data);
        return response.data;
    } catch (error) {
        console.log("❌ Estrategia 7 falló:", error);
        if (axios.isAxiosError(error)) {
            console.log("Status:", error.response?.status);
            console.log("Data:", error.response?.data);
        }
    ...
    // Estrategia 8: POST con datos simples
    try {
        console.log("🔄 Estrategia 8: POST simple");
        ...
        console.log("✅ Estrategia 8 exitosa:", response.data);
        return response.data;
    } catch (error) {
        console.log("❌ Estrategia 8 falló:", error);
        if (axios.isAxiosError(error)) {
            console.log("Status:", error.response?.status);
            console.log("Data:", error.response?.data);
        }
    ...
    console.log("❌ TODAS LAS ESTRATEGIAS FALLARON");
    console.log("Datos enviados:", domicilioData);
    console.log("ID del domicilio:", domicilioId);
    console.log("URL base:", API_BASE_URL);
    
    throw new Error(`No se pudo actualizar el domicilio con ID ${domicilioId}. Se probaron 8 estrategias diferentes. Verifique los logs de la consola para más detalles y contacte al administrador del sistema.`);
};
