...
const RubrosTable: React.FC<RubrosTableProps> = ({
    ...
    const organizedRubros = useMemo(() => {
        ...
        // Identificar los rubros padre (sin rubroPadre)
        const padres = rubrosApi.filter(r => !r.rubroPadre);
        ...
        const getHierarchy = (rubrosArr: RubroApi[]): RubroTable[] => {
            ...
            rubrosArr.forEach(padre => {
                ...
                if (padreTable) {
                    ...
                    // Buscar sus hijos directos usando rubrosApi
                    const hijos = rubrosApi.filter(r => 
                        r.rubroPadre && r.rubroPadre.id === padre.id
                    );
