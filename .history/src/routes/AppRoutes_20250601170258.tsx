...
import Addresses from '../pages/client/modules/profile/Addresses.tsx'; // Importamos el nuevo componente
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/client/profile/addresses" element={<Addresses />} /> {/* Nueva ruta */}
