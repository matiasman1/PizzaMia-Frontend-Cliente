...
interface HeaderProps {
  ...
  onMenuClick?: () => void; // Nueva prop opcional
}

const Header: React.FC<HeaderProps> = ({ activeSection, onNavClick, onMenuClick }) => {
  ...
  // Nueva función para manejar el click del botón hamburguesa
  ...
  return (
    <header className={styles.navbarSections}>
      <div className={styles.logoContainer}>
        {/* Botón hamburguesa - agregar onClick */}
        <button 
      ...
      <nav className={styles.menuItems}>
        ...
        <button 
          className={`${styles.navButton} ${activeSection === "asifunciona" ? styles.active : ""}`} 
          onClick={() => onNavClick && onNavClick("asifunciona")}
        >
          Así funciona
        </button>
        <button 
          className={`${styles.navButton} ${activeSection === "menu" ? styles.active : ""}`} 
          onClick={() => onNavClick && onNavClick("menu")}
        >
          Menú
        </button>
        <button 
          className={`${styles.navButton} ${activeSection === "nosotros" ? styles.active : ""}`} 
          onClick={() => onNavClick && onNavClick("nosotros")}
        >
          Nosotros
        </button>
        <button 
          className={`${styles.navButton} ${activeSection === "footer" ? styles.active : ""}`} 
          onClick={() => onNavClick && onNavClick("footer")}
        >
          Contacto
        </button>
      </nav>
