...
export const useClienteStore = create<ClienteState>()(
  persist(
    (set, get) => ({
      ...
      // CORREGIDA - Cargar datos del cliente por Auth0 ID usando obtenerClientePorId con parseInt
      cargarClientePorAuth0: async (auth0Id: string, token: string) => {
        try {
          ...
          // CAMBIO CRÍTICO: Usar obtenerClientePorId como en el historial que funcionaba
