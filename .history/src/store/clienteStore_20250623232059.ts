...
import { obtenerClientePorId, getUserById, actualizarCliente, obtenerPedidosPorClienteAuth0 } from '../api/clientApi';
...
export const useClienteStore = create<ClienteState>()(
  persist(
    (set, get) => ({
      ...
      // CORREGIDA - Cargar datos del cliente por Auth0 ID usando getUserById
      cargarClientePorAuth0: async (auth0Id: string, token: string) => {
        try {
          ...
          // USAR getUserById en lugar de obtenerClientePorId
