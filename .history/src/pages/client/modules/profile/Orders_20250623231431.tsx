...
// Interfaz para los datos de la tabla (manteniendo la estructura original)
...
const Orders: React.FC = () => {
    ...
    // Función para ver detalles (preparada para futura implementación)
    ...
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => ({
            ...
            estado: pedido.estado.denominacion, // Usar la denominación del estado
    ...
    // Configuración de columnas (manteniendo el estilo original)
    const columns = [
        { 
