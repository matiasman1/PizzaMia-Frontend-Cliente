...
// IMPORTACIÓN DIRECTA DEL SVG - MÉTODO MÁS CONFIABLE
...
const Orders: React.FC = () => {
    ...
    // Convertir pedidos a formato de tabla con SVG importado
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => {
            ...
            return {
                // JSX personalizado con SVG importado directamente
                id: (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        ...
                        >
                            {/* SVG IMPORTADO DIRECTAMENTE - MÉTODO MÁS CONFIABLE */}
                            <img 
                                src={orderIcon} 
                                alt="Pedido" 
                                style={{
                                    width: '24px',
                                    height: '24px',
                                    filter: 'brightness(0) saturate(100%) invert(46%) sepia(95%) saturate(1352%) hue-rotate(16deg) brightness(103%) contrast(101%)'
                                }}
                            />
                        </div>
                        <span 
    ...
    // Configuración de columnas para los estilos
    const columns = [
        { key: 'id', header: 'ID' },
