...
const Orders: React.FC = () => {
    ...
    // Estados para paginación - 6 por página
    ...
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => {
            ...
            return {
                // ÍCONO PERFECTAMENTE CUADRADO - NUEVO ENFOQUE
                id: (
    <div style={{
        display: 'flex',
        alignItems: 'center',
        ...
        {/* CONTENEDOR CUADRADO PERFECTO - MÁS PEQUEÑO */}
        <div
            style={{
                width: '18px',
                height: '18px',
        ...
        >
            {/* ÍCONO SVG CUADRADO MÁS PEQUEÑO */}
            <svg
                width="10"
                height="10"
                viewBox="0 0 24 24"
    ...
    return (
        <ProfileLayout>
            <div className={styles.container}>
                {/* Header con botón de calendario */}
                <div className={styles.header}>
