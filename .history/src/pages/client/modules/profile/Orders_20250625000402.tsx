...
const Orders: React.FC = () => {
    ...
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => {
            const estadoValue = typeof pedido.estado === 'object' && pedido.estado?.denominacion
            ...
            return {
                ...
                estado: (
                    <span
                        style={{
                            backgroundColor: getEstadoColor(estadoValue),
                            color: getEstadoColor(estadoValue) === '#FFC736' ? '#1d1d1d' : 'white',
                            padding: '4px 8px',
                            borderRadius: '12px',
                            fontSize: '11px',
                            fontWeight: '600',
