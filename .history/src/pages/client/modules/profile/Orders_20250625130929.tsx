...
interface OrderForTable {
    id: React.ReactNode; // CORREGIDO: Cambiar de number a React.ReactNode
    fecha: string;
    total: string;
...
const Orders: React.FC = () => {
    ...
    // En la función convertPedidosToTableData, línea aproximada 185:
const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
    return pedidos.map(pedido => {
        ...
        return {
            // CORREGIDO: Cambiar el ID para que muestre un elemento React con el formato correcto
            id: (
            ...
            ) as any, // Necesario para que TypeScript no se queje
            fecha: formatDate(pedido.horaEstimadaFinalizacion || new Date().toISOString()),
