...
interface OrderForTable {
    id: React.ReactNode; // CAMBIO: Volver a React.ReactNode para soportar JSX
    fecha: string;
    total: string;
...
const Orders: React.FC = () => {
    ...
    <div style={{
        ...
        gap: '8px',
        width: '100%',
        marginLeft: '16px' // AÑADIDO: Mueve todo el conjunto hacia la derecha
    }}>
        <img 
            src={orderIcon} 
            alt="Pedido" 
