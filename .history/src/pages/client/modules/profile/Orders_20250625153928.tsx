...
interface OrderForTable {
    id: React.ReactNode; // CAMBIO: Volver a React.ReactNode para el JSX
    fecha: string;
    total: string;
...
const Orders: React.FC = () => {
    ...
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => {
            ...
            return {
                // SOLUCIÓN DEFINITIVA: JSX con ícono cuadrado
                id: (
                    <div style={{
                        display: 'flex',
                        alignItems: 'center',
                        ...
                        <div
                            style={{
                                ...
                                borderRadius: '3px', // REDUCIDO: de 4px a 3px
                        ...
                        >
                            <img
                                ...
                                alt="Pedido"
                                style={{
                                    width: '9px', // REDUCIDO: de 10px a 9px
                                    height: '9px', // REDUCIDO: de 10px a 9px
                                    display: 'block',
                                    objectFit: 'contain'
                                }}
                            />
