...
import { useAuth0 } from '@auth0/auth0-react'; // Corregido: useAuth0 en lugar de useAuth
import { useAppDispatch, useAppSelector } from '../../../../hooks/redux'; // Este import está correcto según el codebase
import { cargarPedidosCliente } from '../../../../redux/slices/PedidoSlice'; // Este import está correcto según el codebase
import { RootState } from '../../../../redux/store/store'; // Este import está correcto según el codebase
import { PedidoVentaResponse } from '../../../../types/dtos/pedidos/PedidoVentaResponse'; // Este import está correcto según el codebase
import { DataTable } from '../../../ui/components/common/DataTable/DataTable'; // Este import está correcto según el codebase
import { Column } from '../../../ui/components/common/DataTable/DataTable'; // Este import está correcto según el codebase
import ProfileLayout from '../ProfileLayout'; // Este import está correcto según el codebase
import { descargarFacturaPDF } from '../../../../api/clientApi'; // Este import está correcto según el codebase
...
const Orders: React.FC = () => {
    const { user, getAccessTokenSilently } = useAuth0(); // Corregido: useAuth0 en lugar de useAuth
