...
import ProfileLayout from '../../../../components/Client/ProfileLayout/ProfileLayout.tsx';
    ...
    const convertPedidosToTableData = (pedidos: PedidoVentaResponse[]): OrderForTable[] => {
        return pedidos.map(pedido => ({
            ...
            estado: (
                <span
                    style={{
                        backgroundColor: getEstadoColor(typeof pedido.estado === 'object' && pedido.estado?.denominacion
                            ? pedido.estado.denominacion
                            : (typeof pedido.estado === 'string' ? pedido.estado : 'Pendiente')),
                        color: getEstadoColor(typeof pedido.estado === 'object' && pedido.estado?.denominacion
                            ? pedido.estado.denominacion
                            : (typeof pedido.estado === 'string' ? pedido.estado : 'Pendiente')) === '#FFC736' ? '#1d1d1d' : 'white',
                        padding: '4px 8px',
                        borderRadius: '12px',
                        fontSize: '11px',
                        fontWeight: '600',
                ...
                >
                    {typeof pedido.estado === 'object' && pedido.estado?.denominacion
                        ? pedido.estado.denominacion
                        : (typeof pedido.estado === 'string' ? pedido.estado : 'Pendiente')}
                </span>
            ),
