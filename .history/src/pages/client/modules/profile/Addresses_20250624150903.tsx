...
const Addresses: React.FC = () => {
    ...
    const setPrimaryAddress = (id: number) => {
        ...
        setOperationSuccess('Dirección principal actualizada');
    ...
    // Guardar dirección (agregar o editar)
                                    ...
                                    <div key={domicilio.id} className={styles.addressCard}>
                                        <div className={styles.cardContent}>
                                            ...
                                            <p className={styles.addressText}>
                                                ...
                                                {domicilio.pisoDpto && `, ${domicilio.pisoDpto}`} <br />                                                {domicilio.localidad.nombre}, CP: {domicilio.codigoPostal}
                                            </p>
