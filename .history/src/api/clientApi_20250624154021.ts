...
export const actualizarCliente = async (
    ...
    try {
        ...
        const datosCompletos = {
            ...
            fechaNacimiento: (clienteData as any).fechaNacimiento,
            auth0Id: auth0Id,
...
// RESTO DE FUNCIONES (mantener todas las existentes)
...
// FUNCIÓN ADICIONAL - Obtener insumos por rubro específico
